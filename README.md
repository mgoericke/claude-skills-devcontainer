...
| Skill | Description |
|-------|-------------|
| **java-scaffold-skill** | Scaffolds new Java projects, entities, and AI services (pom.xml, BCE, Flyway, Taikai) |
| **infrastructure-skill** | Dockerfiles, docker-compose, Helm Charts, and CI/CD pipelines |
